\begin{titlepage}
    ...
    \vspace{0.5cm}
    \begin{Large}{\myAutorNic}\end{Large}\\
	\begin{Large}{\myAutorJannik}\end{Large}\\
	\begin{Large}{\myAutorBen}\end{Large}\\
	\begin{Large}{\myAutorLeon}\end{Large}\\
	\end{center}
	\normalsize
	\vfill
    \begin{tabular}{ l l }
        ...
        \langen{Matriculation Numbers}: & \myMatrikelNrNic, \myMatrikelNrJannik, \myMatrikelNrBen, \myMatrikelNrLeon\\
        \langde{Abgabedatum}
